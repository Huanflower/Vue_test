...
/* WEBPACK VAR INJECTION */}.call(__webpack_exports__, __webpack_require__(1), __webpack_require__(5), __webpack_require__(16).setImmediate))
...
var update = __webpack_require__(22)("2a193c38", content, false);
...
var _trunc = __webpack_require__(26);
    ...
    methods: {
        ...
        send: function send() {
            ...
            this.$axios.post('http://localhost:8888', fd, {
                ...
                onUploadProgress: function onUploadProgress(progressEvnet) {
                    _this.rate = (0, _trunc2.default)(progressEvnet.loaded / progressEvnet.total * 100);
                }
            }).then(function (res) {
                console.log(res);
            }).catch(function (err) {
...
var render = function() {
  ...
  return _c("div", [
    ...
    _vm._v("\n    当前上传进度为：\n    " + _vm._s(_vm.rate) + "%.....\n    "),
    _c("button", { on: { click: _vm.send } }, [_vm._v("发请求")]),
    _vm._v(" "),
    _c("button", { on: { click: _vm.cancel } }, [_vm._v("取消请求")])
  ])
}
var staticRenderFns = []
