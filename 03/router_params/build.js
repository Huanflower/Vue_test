...
router.addRoutes([
    { name: 'list', path: '/list', component:__WEBPACK_IMPORTED_MODULE_2__List_js__["a" /* default */]},
    { name: 'detail', path: '/detail', component: __WEBPACK_IMPORTED_MODULE_4__Detail_js__["a" /* default */] },
    { name: 'detail2', path: '/detail/:mid', component: __WEBPACK_IMPORTED_MODULE_4__Detail_js__["a" /* default */] },
]);
